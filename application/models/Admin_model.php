...
class Admin_model extends CI_Model
{
    ...
    // public function storeBarang($table, $data)
    // {
    ...
    public function getKeluarHarian($limit = null, $id_barang = null, $range = null)
    {
        $this->db->select('*');
        ...
        return $this->db->get('keluar_harian kh')->result_array();
    }
