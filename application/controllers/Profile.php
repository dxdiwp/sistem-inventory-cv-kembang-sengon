...
class Profile extends CI_Controller
{
    ...
    public function index()
    {
        $data['title'] = "Profile";
        $data['user'] = $this->user;
        $this->template->load('templates/admin', 'profile/user', $data);
    }
    ...
    public function setting()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Profile";
            $data['user'] = $this->user;
            $this->template->load('templates/admin', 'profile/setting', $data);
        } else {
    ...
    public function ubahpassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/admin', 'profile/ubahpassword', $data);
        } else {
            $input = $this->input->post(null, true);
