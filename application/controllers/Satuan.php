...
class Satuan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/admin', 'satuan/data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Satuan";
            $this->template->load('templates/admin', 'satuan/add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/admin', 'satuan/edit', $data);
        } else {
            $input = $this->input->post(null, true);
