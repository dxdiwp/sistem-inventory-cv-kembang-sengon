...
class Supplier extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/admin', 'supplier/data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Supplier";
            $this->template->load('templates/admin', 'supplier/add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/admin', 'supplier/edit', $data);
        } else {
            $input = $this->input->post(null, true);
