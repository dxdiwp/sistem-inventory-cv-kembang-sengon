            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="custom-control custom-radio">
                            <input value="keluar_harian" type="radio" id="keluar_harian" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="keluar_harian">Hasil Produksi</label>
                        </div>
                        <?php } else { ?>
                        <div class="custom-control custom-radio">
                            <input value="keluar_harian" type="radio" id="keluar_harian" name="transaksi" class="custom-control-input">
