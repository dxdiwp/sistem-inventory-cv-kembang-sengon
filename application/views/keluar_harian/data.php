...
<div class="card shadow-sm border-bottom-primary">
        ...
        <div class="row">
            <div class="col">
                <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                    Riwayat Data Pengeluaran Bahan Produksi
                </h4>
            </div>
            <div class="col-auto">
                <a href="<?= base_url('keluarharian/add') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
    ...
    <!-- <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Pakam Ayam</a>
      </li>
      <li class="nav-item">
...
<tfoot>
    <tr>
        ...
        <td align="left"><b><?= $totalJumlahKeluar; ?></b></td> 
    </tr>
</tfoot>
