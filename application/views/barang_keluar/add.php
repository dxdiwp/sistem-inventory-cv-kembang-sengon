    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['kd_barang_keluar' => $kd_barang_keluar, 'user_id' => $this->session->userdata('login_session')['user']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="kd_barang_keluar">ID Transaksi Penjualan</label>
                    <div class="col-md-4">
                        <input value="<?= $kd_barang_keluar; ?>" type="text" readonly="readonly" class="form-control">
                        <?= form_error('kd_barang_keluar', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('nama_pembeli'); ?>" name="nama_pembeli" id="nama_pembeli" type="text" class="form-control" >
                                </div>
                                </div>
                                </div>
                                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="alamat_pembeli">Alamat Pembeli</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('alamat_pembeli'); ?>" name="alamat_pembeli" id="alamat_pembeli" type="text" class="form-control" >
                                </div>
                                </div>
                                </div>         
                            <div class="row form-group">
