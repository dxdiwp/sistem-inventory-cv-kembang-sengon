        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('tgl', date('Y-m-d')); ?>" name="tgl" id="tgl" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= set_value('nominal'); ?>" name="nominal" id="nominal" type="text" class="form-control form-control-sm uang">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                            <textarea name="keterangan" id="keterangan" class="form-control" rows="4" ><?= set_value('keterangan'); ?></textarea>
                        </div>
