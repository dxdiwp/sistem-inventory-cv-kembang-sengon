...
<head>
	...
	<title><?= $title; ?> | Sistem Pengelolaan Data Ternak</title>
	...
	<style>
		...
		.sidebar {
			background: rgb(73,137,201) !important;
			background: radial-gradient(circle, rgba(73,137,201,1) 0%, rgba(8,57,107,1) 100%) !important;
		}
...
background: radial-gradient(circle, rgba(63,94,251,1) 0%, rgba(70,252,235,1) 100%) !important;
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav sidebar sidebar-dark  accordion shadow-sm" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex text-white align-items-center justify-content-center" href="">
				...
				<div class="sidebar-brand-text mx-3">Pengelolaan Data Ternak</div>
			...
			<li class="nav-item">
				<a class="nav-link pb-0 collapsed " href="#" data-toggle="collapse" data-target="#collapseMaster1" aria-expanded="true" aria-controls="collapseMaster">
					<i class="fas fa-fw fa-folder"></i>
					<span>Data Barang </span>
				</a>
				<div id="collapseMaster1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?= base_url('barang?q=B000001'); ?>">Bahan Baku</a>
						<a class="collapse-item" href="<?= base_url('barang?q=B000000'); ?>">Bahan Produksi</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseMaster" aria-expanded="true" aria-controls="collapseMaster">
					<i class="fas fa-fw fa-folder"></i>
					<span>Data Kebutuhan Ternak </span>
				</a>
				<div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						
						
						<!-- <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Ternak</a> -->
						<a class="collapse-item" href="<?= base_url('keluarharian'); ?>">Data Keluar Harian</a>
						<a class="collapse-item" href="<?= base_url('keuangan'); ?>">Catatan Keuangan</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link  pb-0" href="<?= base_url('keluarharian'); ?>">
					<i class="fas fa-fw fa-upload"></i>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<!-- Topbar -->
				<nav class="navbar navbar-expand navbar-dark bg-gray-100 topbar mb-4 static-top shadow-sm">
				
				<div class="sidebar-brand-text mx-3 text-lg text-gray-900">PA. BASIRON</div>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline large text-gray-900">
									<?= userdata('nama'); ?>
								</span>
		...
		<script type="text/javascript">
			...
			var myPieChart = new Chart(ctx, {
				...
				data: {
					...
					datasets: [{
						data: [<?= $keluar_harian; ?>, <?= $barang_keluar; ?>],
