        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <!-- <div class="row form-group">
                    <label class="col-md-3 text-md-right">Kategori Barang</label>
                    <div class="col-md-9">
                        <input disabled value="<?= set_value('jenis', $barang['jenis'] == '1' ? 'Bahan Baku' : 'Barang Produksi'); ?>" name="jenis" id="jenis" type="text" class="form-control" placeholder="Kategori Barang...">
                        <?= form_error('jenis', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div> -->
                <?= form_open('', [], ['stok' => 0, 'id_barang' => $barang['id_barang']]); ?>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kd_b_produksi">ID Bahan Baku</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('kd_b_produksi', $barang['kd_b_produksi']); ?>" name="kd_b_produksi" id="kd_b_produksi" type="text" class="form-control" readonly="readonly">
                        <?= form_error('kd_b_produksi', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
