    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kd_b_baku">ID Barang</label>
                    <div class="col-md-9">
                        <input readonly value="<?= set_value('kd_b_baku', $bahanbaku); ?>" name="kd_b_baku" id="kd_b_baku" type="text" class="form-control" readonlu="readonly">
