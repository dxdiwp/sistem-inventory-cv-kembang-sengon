        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('bahanbaku') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kd_b_baku">ID Bahan Baku</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('kd_b_baku', $barang['kd_b_baku']); ?>" name="kd_b_baku" id="kd_b_baku" type="text" class="form-control" readonly="readonly">
