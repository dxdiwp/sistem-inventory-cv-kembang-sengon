...
CREATE TABLE `barang` (
  ...
  `kd_b_baku` char(32) NOT NULL,
  `kd_b_produksi` char(32) NOT NULL,
...
INSERT INTO `barang` (`id_barang`, `kd_b_baku`, `kd_b_produksi`, `nama_barang`, `stok`, `harga`, `jenis`, `satuan_id`) VALUES
...
(7, 'BB-000007', '', 'test tujuh', 0, 123, 1, 5);
...
CREATE TABLE `keluar_harian` (
  `id_keluar_harian` int(11) NOT NULL,
...
(2, 'Pegawai', 'pegawai', 'pegawai@gmail.com', '085747203316', 'gudang', '$2y$10$XZ8vo0GUorIIIS/SZFWFoOFgcJsFZDr8OCae.ycGG1RB2Xu0quFI2', 1704436483, 0),
...
--
ALTER TABLE `hasil_produksi`
  MODIFY `id_hasil_produksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `keluar_harian`
--
ALTER TABLE `keluar_harian`
  MODIFY `id_keluar_harian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
